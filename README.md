...
### 2. Chạy Server bằng Docker (khuyên dùng)

> Docker sẽ tự động khởi động PostgreSQL và Game Server.
...
### 3. Chạy Client (WinForms — chạy trên Windows)
...
| `docker-compose.yml` | Cấu hình Docker: port, mật khẩu DB |
...
**Port 9000 bị chiếm:**
```bash
# Đổi port trong docker-compose.yml: "9001:9000"
